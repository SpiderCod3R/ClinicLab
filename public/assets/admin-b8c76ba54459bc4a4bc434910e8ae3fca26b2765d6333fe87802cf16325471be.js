...
(function() {
  $.rails.allowAction = function(element) {
    ...
    $link = element.clone().removeAttr('class').removeAttr('data-confirm').addClass('btn').addClass('btn-primary').html("Sim");
