...
ActiveRecord::Schema.define(version: 20171002202256) do
  ...
  create_table "sadt_grupos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "sadt_id"
    t.integer  "grupo_id"
    t.integer  "empresa_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["empresa_id"], name: "index_sadt_grupos_on_empresa_id", using: :btree
    t.index ["grupo_id"], name: "index_sadt_grupos_on_grupo_id", using: :btree
    t.index ["sadt_id"], name: "index_sadt_grupos_on_sadt_id", using: :btree
  end
