...
ActiveRecord::Schema.define(version: 20170210195018) do
  ...
  create_table "gclinic_environment_models", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "gclinic_models", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "name"
